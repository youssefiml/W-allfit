...
export default function Login({ setUser }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] flex items-center justify-center p-15 relative overflow-hidden transition-colors duration-300">
      <BackgroundEffects />
                  ...
                  <div className="flex justify-between items-center flex-wrap gap-4 mb-8">
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        setMessage({
                          type: "info",
                          text: "Password reset link would be sent to your email",
                        });
                      }}
                      className="text-gray-600 dark:text-[#a0a0b0] text-sm font-medium no-underline transition-all duration-300 hover:text-pink-400 dark:hover:text-pink-400"
                    >
                      Forgot password?
                    </a>
                  </div>
